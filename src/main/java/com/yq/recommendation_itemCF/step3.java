...
public class step3 {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException{
        ...
        job.setJarByClass(com.yq.recommendation_itemCF.step3.class);
        job.setMapperClass(com.yq.recommendation_itemCF.step3.Mapper3.class);
        job.setReducerClass(com.yq.recommendation_itemCF.step3.Reduce3.class);
