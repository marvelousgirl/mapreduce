...
public class step4 {
    public static class Mapper4 extends Mapper<LongWritable, Text, Text, Text>{
        ...
        protected void setup(Context context ) throws IOException, InterruptedException{
            super.setup(context);
            FileReader fr = new FileReader("output/itemCF/output3/part-r-00000");
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException{
            ...
            String [] item_sim = values[1].split(",");
            ...
            for(String line: cacheList){
                ...
                for(String itemID_score_value : item_sim){
                ...
                outKey.set(itemID);
                outValue.set(userID_matrix2+"_"+df.format(numerator));
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException{
        ...
        job.setJarByClass(com.yq.recommendation_itemCF.step4.class);
        job.setMapperClass(com.yq.recommendation_itemCF.step4.Mapper4.class);
        job.setReducerClass(com.yq.recommendation_itemCF.step4.Reduce4.class);
