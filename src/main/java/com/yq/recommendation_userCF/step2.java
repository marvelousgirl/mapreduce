...
public class step2 {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException{
        ...
        job.setJarByClass(com.yq.recommendation_userCF.step2.class);
        job.setMapperClass(com.yq.recommendation_userCF.step2.Mapper2.class);
        job.setReducerClass(com.yq.recommendation_userCF.step2.Reduce2.class);
